            ...
            <>
               ...
               <hr></hr>
                ...
                <form id="form-adress">
                    ...
                    <input className="input-adress_select" type="select" placeholder="Seleccioná Departamento *" required ></input>
                    <input className="input-adress_select" placeholder="Selecciona la localidd"></input>
                    <input className="input-adress_select" placeholder="Selecciona el barrrio"></input>
                    <input className="input-adress_select" placeholder="numero"></input>
