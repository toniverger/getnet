    ...
    <Page
      content={
        <>
          ...
          <hr></hr>
          <h className="title-data title">¡Gracias por querer ser parte de empresa!</h>
          <p className="subtitle-data subtitle">Ahora sólo necesitamos que completes algunos datos sobre ti y tu empresa"</p>
          <Form />
        </>
      }
    />
